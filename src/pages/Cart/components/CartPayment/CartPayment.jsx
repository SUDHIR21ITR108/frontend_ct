                            ...
                            <div className="card-body p-0">
                                <div className="row g-0">
                                    ...
                                    <div className="col-lg-4">
                                        <div className="p-5">
                                            {/* <img src="https://th.bing.com/th/id/OIP.JXW0v_NZeru7AnLgyonyYwHaE8?pid=ImgDet&rs=1"></img>
                                            <br></br> */}
                                           ...
                                           <button type="button" className="general-button"><Link to="/Login"><button>Proceed To Checkout</button> </Link></button> 
                                        </div>
