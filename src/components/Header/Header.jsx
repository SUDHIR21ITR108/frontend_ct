...
//                         <button className='clean-button' onClick={() => { changeCategory("") }}style={{ marginRight: '30px' }}>Flowering</button>
...
const Header = () => {
    ...
    return (
        <header className='bg-grey'>
                ...
                <div className="header-content">
                    <div className="header-left">
                        <Link to="/">
                            ...
                            <button className='clean-button' onClick={() => { changeCategory("Exterior hardwares") }} style={{ marginRight: '10px' }}>Exterior hardwares</button>
                            <button className='clean-button' onClick={() => { changeCategory("Interior hardwares") }} style={{ marginRight: '10px' }}>Interior hardwares</button>
                            <button className='clean-button' onClick={() => { changeCategory("Other Accessories") }}>Other Accessories</button>
            ...
            <ul className={nav ? 'mobile-nav open-nav  list-unstyled m-0' : 'mobile-nav list-unstyled m-0'}>
                {/* <li><button className='clean-button' onClick={() => { changeCategory("All"); closeHamburger() }}>All Plants</button></li> */}
                <li><button className='clean-button' onClick={() => { changeCategory("Exterior hardwares"); closeHamburger() }}>Exterior hardwares</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Interior hardwares"); closeHamburger() }}>Interior hardwares</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Other Accessories"); closeHamburger() }}>Other Accessories</button></li>
                <div>
                {user && (
        <div>
